...
0x0C0C3030, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,|    # 0x0C - 0x0F |  Bowser (GigaBowser), Peach, Zelda, Sheik
0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,|    # 0x10 - 0x13 |  IceClimber, Marth, G&W, Falco
0xFFFFFFFF, 0x15153535, 0xFFFFFFFF, 0xFFFFFFFF,|    # 0x14 - 0x17 |  Ganon, Wario (WarioMan), MetaKnight, Pit
...
0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,|    # 0x40 - 0x43 |  
